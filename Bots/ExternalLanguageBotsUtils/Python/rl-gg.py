...
def report_preference_vector(gamestate, vector):
    ...
    file_name = f"Logs\\Preference_vectors\\turn_{turn_number}.csv"
...
###  Todo: Make sure to set the right observation size prior to running an experiment!
MODEL_FILEPATH = 'Models\\...training_iterations.zip'
