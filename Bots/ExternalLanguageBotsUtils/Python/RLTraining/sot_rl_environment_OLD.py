...
class TalesOfTribute(gym.Env):
    ...
    def reset(self, seed=None, options=None):
        ...
        self.process = subprocess.Popen(['ScriptsOfTribute-Core-master\\GameRunner\\bin\\Release\\net7.0\\GameRunner',
                          "cmd:python ../../../../Bots/ExternalLanguageBotsUtils/Python/OLD_rl-bridge.py",
                          "MaxPrestigeBot",
                          "-n", "1", 
                          "-t", "1"], 
                          cwd="ScriptsOfTribute-Core-master\\GameRunner\\bin\\Release\\net7.0")
...
if __name__ == "__main__":
    ...
    # model = PPO.load(f"{models_dir}/{date}/..._training_iterations.zip", env)
