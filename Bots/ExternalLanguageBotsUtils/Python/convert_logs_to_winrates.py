...
csv_file = f'RESULTS\\PPO_V14_PPO_vs_itself_0.csv'  # Path to your CSV file
log_dir =  f'RESULTS\\adjusted-logs\\PPO_V14\\PPO_vs_itself_0'  # Directory to save the TensorBoard logs
