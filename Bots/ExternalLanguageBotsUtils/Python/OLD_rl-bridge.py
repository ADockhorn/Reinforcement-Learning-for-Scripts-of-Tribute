...
# Example usage:
# update_win_loss('PLAYER1', 'Bots\\ExternalLanguageBotsUtils\\Python\\Win_Loss_Record.txt')
# update_win_loss('PLAYER2', 'Bots\\ExternalLanguageBotsUtils\\Python\\Win_Loss_Record.txt')
...
def get_game_state():
    ...
    if FINISHED_TOKEN in data:
        ...
        file_path = 'Logs\\V6-rerun-winrate'
