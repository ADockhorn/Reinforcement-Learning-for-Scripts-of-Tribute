...
input_folder = 'Logs\\Preference_vectors'      # Replace with your input folder path
output_csv =   'Logs\\Preference_vector_average.csv'  # Replace with your desired output CSV path
